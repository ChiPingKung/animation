...
void Bone::loadFile()
{
     ...
     ifstream f("skeleton2.out");

     if (f == NULL) {
		cerr << "failed reading skeleton data file " << endl;
		exit(1);
	}
...
void Bone::BodyMotion(float degree)
{
